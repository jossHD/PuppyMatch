...
<body>
 ...
 <section class="mascotas-section">
    <div class="mascotas-nueva ">
        ...
        <form id="agregar_mascota" enctype="multipart/form-data" class="row g-3 needs-validation justify-content-md-center" novalidate>
            <div class="col-sm">
                <div class="col-md-10">
            ...
            <div class="col-md-10 pb-2">
              ...
              <select name="tipo" type="text" list="value" class="form-control" id="validationCustom02"  value ="" required>
            ...
            <div class="col-md-10 pb-2">
              ...
              <input name="edad" type="text" class="form-control" id="validationCustom03" >
            </div>
            <div class="col-md-10 pb-2">              
    ...
    <script src="../scripts/agregar_mascota.js"></script> 
